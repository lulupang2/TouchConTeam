  ...
  return (
    <ScrollView style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <NormalLabel
        ...
        text={`터치콘은 블록체인 기반의 미래형 디지털 자산 리워드 플랫폼입니다. 현실 세계의 보상 서비스에는 주로 포인트, 기프티콘, 리워드 앱 등이 있습니다만, 대부분 유효기간이 설정되어 있거나 사용처 및 용도에 규제가 많아서 제대로 사용하지 못하는 치명적인 단점을 갖고 있습니다. 또한 신규 디지털 자산의 에어드랍 역시 획일적인 무분별한 배포로 인해 그 본래의 잇점을 제대로 살리지 못하고 있습니다.
