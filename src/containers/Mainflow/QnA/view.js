...
const QUESTION_LIST = [
    {id: 1, title: '터치토큰으로 무엇을 할 수 있나요?', content: '터치토큰은 다양한 곳에 사용합니다.\n' +
    ...
    {id: 4, title: '터치쇼핑몰은 무엇인가요?', content: '터치토큰은 다양한 곳에 사용합니다.\n' +
  ...
  return (
    <WhiteSafeAreaView>
      ...
      <View style={styles.topContainer}>
          <FlatList
              ...
              renderItem={({item, index}) =>
                  <Touchable
                    ...
                    style={{
                        ...styles.btnWrapper,
                        backgroundColor: selectedButton === item ? '#fd7f36' : '#f7f7f7',
                        borderColor: selectedButton === item ? '#fd7f36' : '#c4c4c4',
                    }}
                  >
                    <NormalBoldLabel text={item}
                                     style={{
                                        ...styles.btnText, color: selectedButton === item ? '#fff' : '#c4c4c4'
                                     }}
                    />
                  </Touchable>
              }
        ...
        <BottomButton onPress={()=>navigation.navigate('SendMsg')} text={'1:1 문의하기'}/>
    </WhiteSafeAreaView>
  );
};
...
const QnaMenu = ({onPress, isOpen, title, content}) => {
    return (
       <>
           ...
           {isOpen &&
           <View style={{paddingHorizontal: 24, backgroundColor: '#f7f7f7', paddingTop: 32, paddingBottom: 39}}>
...
const styles = StyleSheet.create({
    topContainer: {
        paddingHorizontal: 10, paddingVertical: 6, backgroundColor: '#f7f7f7'
    },
    btnWrapper: {
        width: (width - 35) / 3 - 24,
